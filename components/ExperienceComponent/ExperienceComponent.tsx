...
export default function(){
    ...
    return(
        <>
            ...
            {experienceObject("Graphic Designer", "Well Aliments LLC", "Sep 2017", "Jun 2023", "Part-Time", "At Well Aliments, prioritizing quality was a staple to their success. Working for the pharmaceutical company has its many advantages, one of the most important ones was the wide variety of mediums I can apply my graphic design skills to, from product labels to business cards. It was also my first experience with 3D modeling, creating company products in their 3D form and then applying a label on them. At Well Aliments, I’ve been challenged to reach my full potential, revealing qualities and skills never discovered before.", "https://wellaliments.com/", tagsThree)}
            {experienceObject("Business Development Associate", "Dietica Health International", "July 2020", "July 2021", "Full Time", "My time at Dietica Health International has been instrumental in honing my skills in business strategy, market research, relationship management, and project coordination. I have also developed a deeper understanding of the unique challenges and opportunities within the health and wellness industry, particularly concerning diabetes management.", "https://www.dietica-health.com/", tagsFour)}
        </>
    )
}
