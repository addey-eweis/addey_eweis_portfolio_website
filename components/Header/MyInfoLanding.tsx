            ...
            <section className={styles.fixedInfo}>
                ...
                <div className={styles.bioContainer}>
                    ...
                    <p className={styles.bio}>
                        Since my early days, computers have always had a special place in my heart. Building my first calculator app at the young age of 8, and my personal website at 11. It has given me a glimpse into what would be my future. Now as I look back on my early tinkering years, I have made multiple mobile apps, websites, video games with hands-on experience with multiple languages and frameworks like JavaScript (React JS, Next.js, Node.js, more…), Python (Django), C++, C#, HTML, CSS, SCSS, Bootstrap, among others. It puts me in a state of deep fascination for what the future holds.
                        <br/>
                        <br/>
                        Building on my vast skill-set in software/app/web/game development, and my familiarity with the latest best practices. I&apos;ve also expanded my creative eye for graphic design, working my first job as a graphic designer at Well Aliments. It has given me an incredible amount of hands-on experience, designing brochures, business cards, product labels, and even 3D modeling for more than 20+ clients. It has put me in a position where I have autonomy in my own designing method, with my signature design style that sets me apart from my fellow peers.
                        <br/>
                        <br/>
                        ...
                        <br/>
                        <br/>
                        My journey through the realms of technology, design, and leadership has not only shaped my professional competence but also instilled in me a deeper appreciation for innovation and the potential to make a meaningful difference in the world.                    </p>
                </div>
            </section>
        </>
    )
